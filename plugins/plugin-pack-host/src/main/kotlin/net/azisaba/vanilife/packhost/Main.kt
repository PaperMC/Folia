    ...
    override fun onEnable() {
        val packed = Packed {
            ...
            items {
                ...
                CookingItemModels.CRUCIAN_CARP_ITEM to CookingItemModels.crucianCarpItem()
                ...
                CookingItemModels.EEL_ITEM to CookingItemModels.eelItem()
                ...
                CookingItemModels.FLATFISH_ITEM to CookingItemModels.flatfishItem()
                CookingItemModels.FLOUNDER_ITEM to CookingItemModels.flounderItem()
                ...
                CookingItemModels.HORSE_MACKEREL_ITEM to CookingItemModels.horseMackerelItem()
                ...
                CookingItemModels.MACKEREL_ITEM to CookingItemModels.mackerelItem()
                ...
                CookingItemModels.MONKFISH_ITEM to CookingItemModels.monkfishItem()
                ...
                CookingItemModels.OCTOPUS_ITEM to CookingItemModels.octopusItem()
                ...
                CookingItemModels.SALMON_ITEM to CookingItemModels.salmonItem()
                ...
                CookingItemModels.SEA_BASS_ITEM to CookingItemModels.seaBassItem()
                CookingItemModels.SEA_BREAM_ITEM to CookingItemModels.seaBreamItem()
                CookingItemModels.SEA_URCHIN_ITEM to CookingItemModels.seaUrchinItem()
                ...
                CookingItemModels.SQUID_ITEM to CookingItemModels.squidItem()
                ...
                CookingItemModels.SWEETFISH_ITEM to CookingItemModels.sweetfishItem()
                ...
                CookingItemModels.TUNA_ITEM to CookingItemModels.tunaItem()
                ...
                CookingItemModels.YELLOWTAIL_ITEM to CookingItemModels.yellowtailItem()
            }

            lang {
                PackedKey.lang(Vanilife.NAMESPACE, Locale.US) to (CookingTranslations.us() + PackHostTranslations.us())
                PackedKey.lang(Vanilife.NAMESPACE, Locale.JAPAN) to (CookingTranslations.jp() + PackHostTranslations.jp())
            }
            ...
            models {
                ...
                CookingModels.CLAM to CookingModels.clam()
                ...
                CookingModels.CRUCIAN_CARP to CookingModels.crucianCarp()
                ...
                CookingModels.EEL to CookingModels.eel()
                ...
                CookingModels.FLATFISH to CookingModels.flatfish()
                CookingModels.FLOUNDER to CookingModels.flounder()
                ...
                CookingModels.HORSE_MACKEREL to CookingModels.horseMackerel()
                ...
                CookingModels.MACKEREL to CookingModels.mackerel()
                ...
                CookingModels.SALMON to CookingModels.salmon()
                ...
                CookingModels.SEA_BASS to CookingModels.seaBass()
                CookingModels.SEA_BREAM to CookingModels.seaBream()
                CookingModels.SEA_URCHIN to CookingModels.seaUrchin()
                ...
                CookingModels.SPANISH_MACKEREL to CookingModels.spanishMackerel()
                CookingModels.SPINACH to CookingModels.spinach()
                CookingModels.SQUID to CookingModels.squid()
                ...
                CookingModels.SWEETFISH to CookingModels.sweetfish()
                ...
                CookingModels.TUNA to CookingModels.tuna()
                ...
                CookingModels.YELLOWTAIL to CookingModels.yellowtail()
            }
