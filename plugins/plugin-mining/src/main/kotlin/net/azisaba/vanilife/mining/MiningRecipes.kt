...
object MiningRecipes {
    ...
    private fun coalFromBlastingFrozenCoal(): BlastingRecipe = BlastingRecipe(
        ...
        RecipeChoice.ExactChoice(ItemStack.of(MiningItems.FROZEN_COAL)),
        0.45f,
        50,
    )
    ...
    private fun diamondFromBlastingFrozenDiamond(): BlastingRecipe = BlastingRecipe(
        ...
        RecipeChoice.ExactChoice(ItemStack.of(MiningItems.FROZEN_DIAMOND)),
        1.15f,
        50,
    )
    ...
    private fun emeraldFromBlastingFrozenEmerald(): BlastingRecipe = BlastingRecipe(
        ...
        RecipeChoice.ExactChoice(ItemStack.of(MiningItems.FROZEN_EMERALD)),
        1.05f,
        50,
    )
    ...
    private fun lapisLazuliFromBlastingLapisLazuli(): BlastingRecipe = BlastingRecipe(
        ...
        ItemStack.of(Material.LAPIS_LAZULI),
        RecipeChoice.ExactChoice(ItemStack.of(MiningItems.FROZEN_LAPIS_LAZULI)),
        0.95f,
        50,
    )
    ...
    private fun rawCopperFromBlastingFrozenRawCopper(): BlastingRecipe = BlastingRecipe(
        ...
        ItemStack.of(Material.RAW_COPPER),
        RecipeChoice.ExactChoice(ItemStack.of(MiningItems.FROZEN_RAW_COPPER)),
        0.55f,
        50,
    )
    ...
    private fun rawGoldFromBlastingFrozenRawGold(): BlastingRecipe = BlastingRecipe(
        ...
        ItemStack.of(Material.RAW_GOLD),
        RecipeChoice.ExactChoice(ItemStack.of(MiningItems.FROZEN_RAW_GOLD)),
        0.75f,
        50,
    )
    ...
    private fun rawIronFromBlastingFrozenRawIron(): BlastingRecipe = BlastingRecipe(
        ...
        RecipeChoice.ExactChoice(ItemStack.of(MiningItems.FROZEN_RAW_IRON)),
        0.65f,
        50,
    )
    ...
    private fun redstoneFromBlastingFrozenRedstone(): BlastingRecipe = BlastingRecipe(
        ...
        RecipeChoice.ExactChoice(ItemStack.of(MiningItems.FROZEN_REDSTONE)),
        0.85f,
        50,
    )
